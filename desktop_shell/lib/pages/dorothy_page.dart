    ...
    return BotHubTemplate(
      ...
      formFields: const [
        ...
        BotFormField(key: 'drop_factor', label: 'Drop %', hint: '0.97', defaultValue: '0.97',
            inputType: TextInputType.number),
        BotFormField(key: 'qty_decimals', label: 'Qty Dec', hint: '8', defaultValue: '8',
            inputType: TextInputType.number),
        BotFormField(key: 'price_decimals', label: 'Price Dec', hint: '4', defaultValue: '4',
            inputType: TextInputType.number),
        BotFormField(key: 'max_drawdown_pct', label: 'Max DD %', hint: '0.20', defaultValue: '0.20',
            inputType: TextInputType.number),
        BotFormField(key: 'metrics_every', label: 'Metrics N', hint: '5', defaultValue: '5',
            inputType: TextInputType.number),
