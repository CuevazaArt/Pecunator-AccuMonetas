...
_DEFAULT_REGISTRY: list[SubAccountEntry] = [
    SubAccountEntry(
        ...
        role="strategy",
        bot_type="louise",
        description="BlueChip long-term accumulation — Louise DCA bot (BTC, ETH, BNB, SOL)",
        symbols=["BTCUSDT", "ETHUSDT", "BNBUSDT", "SOLUSDT"],
        max_equity_usdt="5000",
    ...
    SubAccountEntry(
        ...
        role="bot",
        bot_type="dorothy",
        description="DCA long bot — INACTIVE (migrated to Louise/bluechip)",
        symbols=[],
        max_equity_usdt="0",
    ...
    SubAccountEntry(
        ...
        role="bot",
        bot_type="elphaba",
        description="DCA short bot — INACTIVE (migrated to Louise/bluechip)",
        symbols=[],
        max_equity_usdt="0",
